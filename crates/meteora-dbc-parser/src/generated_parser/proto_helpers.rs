...
pub mod proto_types_parsers {
    ...
    use crate::types::EvtClaimPoolCreationFee;
    impl IntoProto<proto_def::EvtClaimPoolCreationFee> for EvtClaimPoolCreationFee {
        fn into_proto(self) -> proto_def::EvtClaimPoolCreationFee {
            proto_def::EvtClaimPoolCreationFee {
                pool: self.pool.to_string(),
