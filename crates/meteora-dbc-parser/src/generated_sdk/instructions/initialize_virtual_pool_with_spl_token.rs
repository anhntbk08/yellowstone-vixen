...
pub const INITIALIZE_VIRTUAL_POOL_WITH_SPL_TOKEN_DISCRIMINATOR: [u8; 8] =
...
impl InitializeVirtualPoolWithSplToken {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = InitializeVirtualPoolWithSplTokenInstructionData::new()
            .try_to_vec()
            .unwrap();
...
impl InitializeVirtualPoolWithSplTokenInstructionArgs {
    pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
        borsh::to_vec(self)
    }
}
