...
pub const CLAIM_CREATOR_TRADING_FEE_DISCRIMINATOR: [u8; 8] = [82, 220, 250, 189, 3, 85, 107, 45];
...
impl ClaimCreatorTradingFee {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = ClaimCreatorTradingFeeInstructionData::new()
            .try_to_vec()
            .unwrap();
...
impl ClaimCreatorTradingFeeInstructionArgs {
    pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
        borsh::to_vec(self)
    }
}
