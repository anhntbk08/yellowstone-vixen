...
pub const MIGRATION_DAMM_V2_CREATE_METADATA_DISCRIMINATOR: [u8; 8] =
...
impl MigrationDammV2CreateMetadata {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = MigrationDammV2CreateMetadataInstructionData::new()
            .try_to_vec()
            .unwrap();
...
impl MigrationDammV2CreateMetadataInstructionData {
    pub fn new() -> Self {
        Self {
...
pub struct MigrationDammV2CreateMetadataBuilder {
...
impl MigrationDammV2CreateMetadataBuilder {
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        let accounts = MigrationDammV2CreateMetadata {
...
/// `migration_damm_v2_create_metadata` CPI accounts.
pub struct MigrationDammV2CreateMetadataCpiAccounts<'a, 'b> {
...
/// `migration_damm_v2_create_metadata` CPI instruction.
pub struct MigrationDammV2CreateMetadataCpi<'a, 'b> {
...
impl<'a, 'b> MigrationDammV2CreateMetadataCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: MigrationDammV2CreateMetadataCpiAccounts<'a, 'b>,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `MigrationDammV2CreateMetadata` via CPI.
///
/// ### Accounts:
///
///   0. `[]` virtual_pool
...
///   6. `[]` program
#[derive(Clone, Debug)]
pub struct MigrationDammV2CreateMetadataCpiBuilder<'a, 'b> {
    instruction: Box<MigrationDammV2CreateMetadataCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> MigrationDammV2CreateMetadataCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(MigrationDammV2CreateMetadataCpiBuilderInstruction {
            __program: program,
            virtual_pool: None,
            config: None,
    ...
    #[allow(clippy::vec_init_then_push)]
    pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        let instruction = MigrationDammV2CreateMetadataCpi {
...
#[derive(Clone, Debug)]
struct MigrationDammV2CreateMetadataCpiBuilderInstruction<'a, 'b> {
