...
pub const CREATE_PARTNER_METADATA_DISCRIMINATOR: [u8; 8] = [192, 168, 234, 191, 188, 226, 227, 255];
...
impl CreatePartnerMetadata {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = CreatePartnerMetadataInstructionData::new()
            .try_to_vec()
            .unwrap();
...
impl CreatePartnerMetadataInstructionArgs {
    pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
        borsh::to_vec(self)
    }
}
