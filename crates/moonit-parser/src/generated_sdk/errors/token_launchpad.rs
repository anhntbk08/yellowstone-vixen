...
pub enum TokenLaunchpadError {
    ...
    #[error("General error")]
    General = 0x1793,
    /// 6036 - This token has anti-snipe measures. Trade on https://moon.it
    #[error("This token has anti-snipe measures. Trade on https://moon.it")]
    BackendAuthorityRequiredToTrade = 0x1794,
    /// 6037 - Only anti-snipe curves can be traded using this instruction
    #[error("Only anti-snipe curves can be traded using this instruction")]
    OnlyAntiSnipeCurves = 0x1795,
}

impl From<TokenLaunchpadError> for solana_program_error::ProgramError {
