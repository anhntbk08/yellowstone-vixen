...
pub const CONFIG_INIT_DISCRIMINATOR: [u8; 8] = [13, 236, 164, 173, 106, 253, 164, 185];
...
impl ConfigInit {
    pub fn instruction(&self, args: ConfigInitInstructionArgs) -> solana_instruction::Instruction {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = ConfigInitInstructionData::new().try_to_vec().unwrap();
...
impl ConfigInitInstructionArgs {
    pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
        borsh::to_vec(self)
    }
}
