...
pub const BUY_WITH_BE_AUTHORITY_DISCRIMINATOR: [u8; 8] = [79, 77, 171, 237, 157, 49, 235, 198];

/// Accounts.
#[derive(Debug)]
pub struct BuyWithBeAuthority {
    /// BE Authority
...
impl BuyWithBeAuthority {
    pub fn instruction(
        &self,
        args: BuyWithBeAuthorityInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = BuyWithBeAuthorityInstructionData::new()
            .try_to_vec()
            .unwrap();
...
pub struct BuyWithBeAuthorityInstructionData {
    discriminator: [u8; 8],
}

impl BuyWithBeAuthorityInstructionData {
    pub fn new() -> Self {
        Self {
...
impl Default for BuyWithBeAuthorityInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct BuyWithBeAuthorityInstructionArgs {
    pub data: TradeParams,
}

impl BuyWithBeAuthorityInstructionArgs {
    pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
        borsh::to_vec(self)
    }
}

/// Instruction builder for `BuyWithBeAuthority`.
///
/// ### Accounts:
///
...
pub struct BuyWithBeAuthorityBuilder {
...
impl BuyWithBeAuthorityBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    /// BE Authority
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        let accounts = BuyWithBeAuthority {
        ...
        let args = BuyWithBeAuthorityInstructionArgs {
...
/// `buy_with_be_authority` CPI accounts.
pub struct BuyWithBeAuthorityCpiAccounts<'a, 'b> {
    /// BE Authority
...
/// `buy_with_be_authority` CPI instruction.
pub struct BuyWithBeAuthorityCpi<'a, 'b> {
    ...
    pub __args: BuyWithBeAuthorityInstructionArgs,
}

impl<'a, 'b> BuyWithBeAuthorityCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: BuyWithBeAuthorityCpiAccounts<'a, 'b>,
        args: BuyWithBeAuthorityInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `BuyWithBeAuthority` via CPI.
///
/// ### Accounts:
///
///   0. `[signer]` backend_authority
...
///   11. `[]` system_program
#[derive(Clone, Debug)]
pub struct BuyWithBeAuthorityCpiBuilder<'a, 'b> {
    instruction: Box<BuyWithBeAuthorityCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> BuyWithBeAuthorityCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(BuyWithBeAuthorityCpiBuilderInstruction {
            __program: program,
    ...
    pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        ...
        let instruction = BuyWithBeAuthorityCpi {
...
#[derive(Clone, Debug)]
struct BuyWithBeAuthorityCpiBuilderInstruction<'a, 'b> {
