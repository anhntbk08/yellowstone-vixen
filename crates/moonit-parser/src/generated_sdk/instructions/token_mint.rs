...
pub const TOKEN_MINT_DISCRIMINATOR: [u8; 8] = [3, 44, 164, 184, 123, 13, 245, 179];
...
impl TokenMint {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = TokenMintInstructionData::new().try_to_vec().unwrap();
...
pub struct TokenMintInstructionArgs {
    ...
    pub collateral_collected: u64,
}

impl TokenMintInstructionArgs {
    pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
        borsh::to_vec(self)
    }
}
...
pub struct TokenMintBuilder {
    ...
    price_increase: Option<u16>,
    collateral_collected: Option<u64>,
...
impl TokenMintBuilder {
    ...
    #[inline(always)]
    pub fn price_increase(&mut self, price_increase: u16) -> &mut Self {
        self.price_increase = Some(price_increase);
        self
    }
    #[inline(always)]
    pub fn collateral_collected(&mut self, collateral_collected: u64) -> &mut Self {
        self.collateral_collected = Some(collateral_collected);
        self
    }
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        ...
        let args = TokenMintInstructionArgs {
            ...
            price_increase: self
                .price_increase
                .clone()
                .expect("price_increase is not set"),
            collateral_collected: self
                .collateral_collected
                .clone()
                .expect("collateral_collected is not set"),
        };
...
impl<'a, 'b> TokenMintCpiBuilder<'a, 'b> {
    ...
    #[inline(always)]
    pub fn price_increase(&mut self, price_increase: u16) -> &mut Self {
        self.instruction.price_increase = Some(price_increase);
        self
    }
    #[inline(always)]
    pub fn collateral_collected(&mut self, collateral_collected: u64) -> &mut Self {
        self.instruction.collateral_collected = Some(collateral_collected);
        self
    }
    /// Add an additional account to the instruction.
    #[inline(always)]
