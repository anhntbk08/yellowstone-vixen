...
pub const CONFIG_UPDATE_DISCRIMINATOR: [u8; 8] = [80, 37, 109, 136, 82, 135, 89, 241];
...
impl ConfigUpdate {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = ConfigUpdateInstructionData::new().try_to_vec().unwrap();
...
impl ConfigUpdateInstructionArgs {
    pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
        borsh::to_vec(self)
    }
}
