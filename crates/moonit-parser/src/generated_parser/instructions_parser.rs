...
use crate::instructions::{
    ...
    BuyWithBeAuthority as BuyWithBeAuthorityIxAccounts,
    BuyWithBeAuthorityInstructionArgs as BuyWithBeAuthorityIxData,
    ConfigInit as ConfigInitIxAccounts, ConfigInitInstructionArgs as ConfigInitIxData,
    ConfigUpdate as ConfigUpdateIxAccounts, ConfigUpdateInstructionArgs as ConfigUpdateIxData,
    MigrateFunds as MigrateFundsIxAccounts, Sell as SellIxAccounts,
    SellInstructionArgs as SellIxData, TokenMint as TokenMintIxAccounts,
    TokenMintInstructionArgs as TokenMintIxData,
};
use crate::ID;
...
pub enum TokenLaunchpadProgramIx {
    ...
    BuyWithBeAuthority(BuyWithBeAuthorityIxAccounts, BuyWithBeAuthorityIxData),
...
impl yellowstone_vixen_core::Parser for InstructionParser {
    ...
    fn id(&self) -> std::borrow::Cow<'static, str> {
        "TokenLaunchpad::InstructionParser".into()
    }
...
impl InstructionParser {
    pub(crate) fn parse_impl(
        ...
        let ix = match ix_discriminator {
            ...
            [79, 77, 171, 237, 157, 49, 235, 198] => {
                let expected_accounts_len = 12;
                check_min_accounts_req(accounts_len, expected_accounts_len)?;
                let ix_accounts = BuyWithBeAuthorityIxAccounts {
                ...
                let de_ix_data: BuyWithBeAuthorityIxData =
                    deserialize_checked(ix_data, &ix_discriminator)?;
                Ok(TokenLaunchpadProgramIx::BuyWithBeAuthority(
                    ix_accounts,
                    de_ix_data,
                ))
            },
...
// #[cfg(feature = "proto")]
mod proto_parser {
    use super::{InstructionParser, TokenLaunchpadProgramIx};
    ...
    use super::BuyWithBeAuthorityIxAccounts;
    impl IntoProto<proto_def::BuyWithBeAuthorityIxAccounts> for BuyWithBeAuthorityIxAccounts {
        fn into_proto(self) -> proto_def::BuyWithBeAuthorityIxAccounts {
            proto_def::BuyWithBeAuthorityIxAccounts {
    ...
    use super::BuyWithBeAuthorityIxData;
    impl IntoProto<proto_def::BuyWithBeAuthorityIxData> for BuyWithBeAuthorityIxData {
        fn into_proto(self) -> proto_def::BuyWithBeAuthorityIxData {
            proto_def::BuyWithBeAuthorityIxData {
                data: Some(self.data.into_proto()),
            }
        }
    }
    ...
    impl IntoProto<proto_def::TokenMintIxData> for TokenMintIxData {
        fn into_proto(self) -> proto_def::TokenMintIxData {
            proto_def::TokenMintIxData {
                ...
                collateral_collected: self.collateral_collected,
            }
        }
    }
    ...
    impl IntoProto<proto_def::ProgramIxs> for TokenLaunchpadProgramIx {
        fn into_proto(self) -> proto_def::ProgramIxs {
            match self {
                ...
                TokenLaunchpadProgramIx::BuyWithBeAuthority(acc, data) => proto_def::ProgramIxs {
                    ix_oneof: Some(proto_def::program_ixs::IxOneof::BuyWithBeAuthority(
                        proto_def::BuyWithBeAuthorityIx {
                            accounts: Some(acc.into_proto()),
                            data: Some(data.into_proto()),
                        },
                    )),
